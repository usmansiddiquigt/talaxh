...
function maskPhone(phone) {
  ...
  return t.slice(0, 3) + '*'.repeat(t.length - 3);
}
          ...
          <View style={styles.section}>
            ...
            <View style={styles.sellerCard}>
              ...
              >
                ...
                <Text style={styles.sellerCallText}>
                  {sellerPhone ? `Call ${maskPhone(sellerPhone)}` : 'Call Seller'}
                </Text>
              </TouchableOpacity>
            </View>
          </View>
      ...
      <View style={styles.bottomBar}>
        <TouchableOpacity style={styles.callBtn} onPress={handleCall}>
          ...
          <View style={{ alignItems: 'flex-start' }}>
            ...
            {sellerPhone ? (
              <Text style={styles.callBtnPhone} numberOfLines={1}>{maskPhone(sellerPhone)}</Text>
            ) : null}
          </View>
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  sellerCallText: { color: '#fff', fontSize: 14, fontWeight: '800' },
  sellerAvatar: {
    width: 48,
    height: 48,
    borderRadius: 24,
