...
const SETTINGS_ITEMS = [
  { icon: 'notifications-none', label: 'Notifications',      screen: 'Notifications' },
  { icon: 'privacy-tip',        label: 'Privacy & Security', screen: 'Privacy'       },
  { icon: 'help-outline',       label: 'Help & Support',     screen: 'Help'          },
  { icon: 'info-outline',       label: 'About Talash',       screen: 'About'         },
];
          ...
          <View style={styles.menuCard}>
            {MENU_ITEMS.map((item, i) => (
              <TouchableOpacity
                ...
                onPress={() => navigation.navigate(item.screen, { from: 'Account' })}
              >
